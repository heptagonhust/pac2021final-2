...
herr_t ChipMaskHDF5::writeDataSet(std::string chipID, slideRange& sliderange, BarcodeMap& bpMap, uint32_t barcodeLen, uint8_t segment, uint32_t slidePitch, uint compressionLevel, int index){
